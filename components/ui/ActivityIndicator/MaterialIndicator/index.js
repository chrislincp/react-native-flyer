...
import { View, Animated, Easing, Platform, ActivityIndicator } from 'react-native';
...
class MIndicator extends PureComponent {
  ...
  render() {
    const {
      style, size: width, size: height, ...props
    } = this.props;
...
const MaterialIndicator = Platform.OS == 'android' ? ActivityIndicator : MIndicator;
